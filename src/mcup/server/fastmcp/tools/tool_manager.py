...
from mcup.server.fastmcp.tools.base import Tool
from mcup.server.fastmcp.utilities.logging import get_logger
from mcup.shared.context import LifespanContextT, RequestT
from mcup.types import ToolAnnotations

if TYPE_CHECKING:
    from mcup.server.fastmcp.server import Context

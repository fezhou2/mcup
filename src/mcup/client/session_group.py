...
class ClientSessionGroup:
    ...
    _sessions: dict[mcup.ClientSession, _ComponentNames]
    _tool_to_session: dict[str, mcup.ClientSession]
    _exit_stack: contextlib.AsyncExitStack
    _session_exit_stacks: dict[mcup.ClientSession, contextlib.AsyncExitStack]
    ...
    @property
    def sessions(self) -> list[mcup.ClientSession]:
    ...
    async def disconnect_from_server(self, session: mcup.ClientSession) -> None:
    ...
    async def connect_with_session(
        self, server_info: types.Implementation, session: mcup.ClientSession
    ) -> mcup.ClientSession:
    ...
    async def _establish_session(
    ...
    ) -> tuple[types.Implementation, mcup.ClientSession]:
        ...
        try:
            ...
            if isinstance(server_params, StdioServerParameters):
                client = mcup.stdio_client(server_params)
            ...
            session = await session_stack.enter_async_context(mcup.ClientSession(read, write))
    ...
    async def _aggregate_components(self, server_info: types.Implementation, session: mcup.ClientSession) -> None:
        ...
        tool_to_session_temp: dict[str, mcup.ClientSession] = {}

...
from mcup.shared._httpx_utils import McpHttpClientFactory, create_mcp_http_client
from mcup.shared.message import ClientMessageMetadata, SessionMessage
...
from .session import ClientSession  # Existing
from .mcup_session import MCUPSession  # Added
...
async def streamablehttp_client(
    ...
    auth: httpx.Auth | None = None,
    approval_mode: Optional[str] = None,  # Added
) -> AsyncGenerator[ClientSession, None]:  # Modified to yield ClientSession
    """
    ...
    Args:
        ...
        terminate_on_close: Whether to send DELETE request on close.
